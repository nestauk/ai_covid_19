...
fetch:
	$(PYTHON_INTERPRETER) ai_covid_19/fetch_data.py
	make sync_data_to_s3

## Sync raw from s3 and make Dataset
data:
	sync_data_from_s3
	$(PYTHON_INTERPRETER) ai_covid_19/make_dataset.py
...
lint:
	black ai_covid_19; flake8 ai_covid_19
